...
{	
	...
	// send 1st mail
	$to_Email   	= "chidichristopher0@gmail.com"; //put church mail here
	...
	$headers .= "Bcc: chidichristopher0@gmail.com" . "\r\n";
	$sentMail = @mail($to_Email, $subject, $message, $headers);
	if(!$sentMail)
	{
		$output = json_encode(array('type'=>'error', 'text' => 'Oops! Something went wrong while sending your message. Please try again later or contact us directly.'));
	...
	$output = json_encode(array('type'=>'message', 'text' => 'Hello '.$name .', thank you for reaching out! Your message has been received, and we will get back to you shortly.'));
	die($output);
}
?>