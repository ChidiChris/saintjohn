...
window.addEventListener("load", function () {
  ...
  if (navigationTiming) {
    ...
    console.log(`\n> 🚀 Welcome to St. John's Cathedral website! Page fully loaded in ${loadTime > 0 ? loadTime : 0} seconds.`);
    console.log("📊 Performance Navigation Timing:", navigationTiming); // Logs the full navigation timing
  } else {
    console.log("\n> St. John's Cathedral website: Unable to calculate load time. Navigation Timing API not supported.");
  }
});
